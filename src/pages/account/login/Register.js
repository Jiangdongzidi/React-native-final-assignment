...
import { View, Text, Button, StatusBar, Image, Alert} from 'react-native'
        ...
        return (
            <View>
                ...
                <View style={{padding:pxToDp(20)}}>
                    <View>
                        <View><Text style={{fontSize:pxToDp(20),color:"#000",fontWeight:"bold", marginTop:10}}>账号注册</Text></View>
                    </View>
                    {/* 手机号 */}
                    <View>
                    ...
                    <View style={{marginTop:5}}>
                        <Text 
                            style={{color:"#00b4fe",fontSize:13,marginLeft:220,marginBottom:30}}
                            onPress={()=>{
